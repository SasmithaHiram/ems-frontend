...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-gray-100 via-gray-200 to-gray-100 flex items-center justify-center px-4">
      {/* Login Card */}
      <div className="bg-white shadow-2xl rounded-2xl p-8 sm:p-10 w-full max-w-md border border-gray-200">
        ...
        <p className="text-center text-gray-600 mb-8 text-sm">
          Learn. Grow. Perform - Sign in to NEXTA
        </p>
        ...
        <p className="text-center text-gray-500 text-xs mt-8">
          &copy; {new Date().getFullYear()} K.B Sasmitha Hiram Mendis. All
          rights reserved.
        </p>
      </div>
    </div>
